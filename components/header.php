...
<head>
    ...
    <link rel="stylesheet" href="/catering/styles/styles.css" />
    <title>Catering</title>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
    <script src="/catering/scripts/main.js"></script>
</head> -->
<body>
    <header>
        <div class="container">
            <div class="navigation-wrapper">
                <ul class="navigation d-flex justify-content-end list-unstyled mb-0 py-4">
                    <li class="me-auto">
                        <a href="/catering">
                    ...
                    <?php else :?>
                        <li class="navigation-item">
                            <a href="/catering/conectare">Conectare</a>
                        </li>
                    <?php endif ?>
                </ul>
            </div>
